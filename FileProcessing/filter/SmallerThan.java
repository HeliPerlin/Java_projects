...
/**
 * implements the smaller_than filter
 */
public class SmallerThan extends Filter{

    /*
    the lower boundary of the size of a file that passes the filter
     */
     ...
     */
    public SmallerThan(double boundary, boolean NotIsOn) throws TypeIException {
        super(NotIsOn);
        if (boundary < 0){
    ...
    public boolean accept(File pathname) {
        ...
        // TODO: Check if smaller or equal
        if (this.NotIsOn){
